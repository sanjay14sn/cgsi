...
const AboutSection = () => {
  return (
    <section className="py-14 sm:py-20 md:py-24 relative overflow-hidden bg-background">
      ...
      <div className="absolute w-[800px] h-[800px] -top-[400px] -right-[200px] blur-[120px] rounded-full opacity-10 bg-gradient-to-br from-primary to-accent pointer-events-none hidden sm:block" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative z-10 group">
              <div className="relative rounded-2xl sm:rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-500 group-hover:shadow-[0_0_50px_-12px_rgba(var(--primary),0.3)] border-2 border-white/10 group-hover:border-primary/50">
          ...
          <div className="space-y-8">
            <motion.h2
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight text-black"
            >
            ...
            <motion.div
              ...
              className="text-base sm:text-lg leading-relaxed text-black border-l-2 border-primary/20 pl-4 sm:pl-6 font-semibold space-y-4"
            >
              <p>
            ...
            >
              <Link
                to="/about"
                className="group inline-flex items-center gap-3 px-6 sm:px-10 py-3.5 sm:py-4 rounded-full text-primary-foreground font-bold transition-all hover:scale-105 shadow-xl shadow-primary/20 bg-primary hover:bg-primary/90 text-sm sm:text-base"
              >
                Learn About CGSI
