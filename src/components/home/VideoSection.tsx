            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <motion.p
                        ...
                        className="max-w-3xl mx-auto text-black text-lg leading-relaxed font-semibold"
                    >
                ...
                {/* 6 Images Grid View */}
                <div className="mb-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto items-start">
                    {[
